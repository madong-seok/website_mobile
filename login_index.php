        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                       <ul>
                            <li class="php_hl"> <?php echo "<span style='color: #5a88ca;font-size: 16px;font-style: italic;'> Xin chào    </span>".$_SESSION['username']; ?></li>  
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="login.php" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ</a>
