 ...
 <div class="single-product-area">
        ...
        <div class="container">            
            <div class="row">
                ...
                <?php
        $query = mysqli_query($conn, "SELECT * FROM `products` WHERE `NameProduct` LIKE '%$keyword%' OR `Brand` LIKE '%$keyword%' OR `Price` LIKE '%$keyword%'  ORDER BY `NameProduct`");
        while($se = mysqli_fetch_array($query)){
    ?>
        <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                           <a href="single_product.php?id=<?php echo $se['ID_Product']?>"><img src="img/<?php echo $se['Image'] ?>" alt=""></a> 
                        </div>
                        <h2><a href="single_product.php?id=<?php echo $se['ID_Product'] ?>"><?php echo $se['NameProduct'] ?></a></h2>
                        <div class="product-carousel-price">
                           <span >Giá sản phẩm:</span> <ins><?php echo number_format($se['Price']) ?></ins>
                        </div>  
