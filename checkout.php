                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                <label class="" for="billing_first_name">Họ & tên đệm <abbr title="required" class="required">*</abbr>
                                                </label>
                                            ...
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <input type="text" value="" placeholder="Tên đường/phường" id="billing_address_1" name="billing_address_1" class="input-text ">
                                            </p>

                                            <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                                <input type="text" value="" placeholder="Ngõ, ngách, số nhà..." id="billing_address_2" name="billing_address_2" class="input-text ">
                                            </p>
                                            <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_city">Quận / Huyện <abbr title="required" class="required">*</abbr>
                                                </label>
                                            ...
                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                <label class="" for="billing_postcode">Mã Zip Code <abbr title="required" class="required">*</abbr>
                                                </label>
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Iphone 13 Pro <strong class="product-quantity">× 1</strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">35.000.000 VND</span> </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Samsung Note 10 <strong class="product-quantity">× 1</strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">25.000.000 VND</span> </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Tổng tiền</th>
                                                <td><span class="amount">60.000.000 VND</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Thanh toán</th>
                                                <td><strong><span class="amount">60.000.000 VND</span></strong> </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            ...
                                            <li class="payment_method_paypal">
                                                ...
                                                PayPal <img alt="PayPal Acceptance Mark" src="https://www.paypalobjects.com/webstatic/mktg/Logo/AM_mc_vs_ms_ae_UK.png">
                                                </label>
                                        ...
                                        <input type="submit" value="Thanh toán" name="sub_dk">
                                        <?php 
