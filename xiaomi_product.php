            ...
            <div class="row">
             ...
             <?php
                   ...
                   // $offset = ($current_page - 1) * $item_per_page;
                    $products = $get_data -> se_product_xiaomi();
                ...
                ?>
                    ...
                    <div class="single-shop-product">
                        <div class="product-upper">
                           <a href="single_product.php?id=<?php echo $pro['ID_Product']?>"><img src="img/<?php echo $pro['Image'] ?>" alt=""></a> 
                        </div>
                        <h2><a href="single_product.php?id=<?php echo $pro['ID_Product'] ?>"><?php echo $pro['NameProduct'] ?></a></h2>
                        <div class="product-carousel-price">
                            <span>Giá sản phẩm:</span> <ins><?php echo number_format($pro['Price']) ?></ins><span>VND</span>  
                        </div>  
